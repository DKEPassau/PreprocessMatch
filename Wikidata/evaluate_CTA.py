...
class CTA_Evaluator:
    ...
    def _evaluate(self, client_payload, _context={}):
        ...
        gt_ancestor = json.load(
            open("./Dataset/Valid/gt/cta_gt_ancestor.json"))
        gt_descendent = json.load(
            open("./Dataset/Valid/gt/cta_gt_descendent.json"))
        ...
        precision = total_score / \
            len(annotated_cols) if len(annotated_cols) > 0 else 0
...
if __name__ == "__main__":
    ...
    answer_file_path = "./Dataset/Valid/gt/cta_gt.csv"
    d = '/Users/jiahen/Downloads/CTA/'
    print("Scores for first experiment")
    # Instaiate a dummy context
    _context = {}
    _client_payload = {}
    _client_payload["submission_file_path"] = "./Dataset/output/cta annotation/cta_wikidata_first_experiment.csv"
    ...
    _context = {}
    _client_payload = {}
    _client_payload["submission_file_path"] = "./Dataset/output/cta annotation/cta_wikidata_second_experiment.csv"
    ...
    _context = {}
    _client_payload = {}
    _client_payload["submission_file_path"] = "./Dataset/output/cta annotation/cta_wikidata_third_experiment.csv"
